...
WH.Types = new function () {
    ...
    const n = {
        ...
        [WH.dataTree.CLASSIC]: [this.FACTION, this.GATHERER_GUIDE_IMAGE, this.GATHERER_LISTVIEW, this.GATHERER_SCREENSHOT, this.GEAR_SET, this.GUIDE, this.HUNTER_PET, this.ICON, this.ITEM, this.ITEM_SET, this.NPC, this.OBJECT, this.OUTFIT, this.PLAYER_CLASS, this.QUEST, this.RACE, this.RESOURCE, this.SKILL, this.SOUND, this.SPELL, this.ZONE],
        [WH.dataTree.TBC]: [this.FACTION, this.GATHERER_GUIDE_IMAGE, this.GATHERER_LISTVIEW, this.GATHERER_SCREENSHOT, this.GEAR_SET, this.GUIDE, this.HUNTER_PET, this.ICON, this.ITEM, this.ITEM_SET, this.NPC, this.OBJECT, this.OUTFIT, this.PLAYER_CLASS, this.QUEST, this.RACE, this.RESOURCE, this.SKILL, this.SOUND, this.SPELL, this.ZONE],
        [WH.dataTree.WRATH]: [this.ACHIEVEMENT, this.CURRENCY, this.EVENT, this.FACTION, this.GATHERER_GUIDE_IMAGE, this.GATHERER_LISTVIEW, this.GATHERER_SCREENSHOT, this.GEAR_SET, this.GUIDE, this.HUNTER_PET, this.ICON, this.ITEM, this.ITEM_SET, this.NPC, this.OBJECT, this.OUTFIT, this.PLAYER_CLASS, this.QUEST, this.RACE, this.RESOURCE, this.SKILL, this.SOUND, this.SPELL, this.ZONE],
        [WH.dataTree.CATA]: [this.ACHIEVEMENT, this.CURRENCY, this.EVENT, this.FACTION, this.GATHERER_GUIDE_IMAGE, this.GATHERER_LISTVIEW, this.GATHERER_SCREENSHOT, this.GEAR_SET, this.GUIDE, this.HUNTER_PET, this.ICON, this.ITEM, this.ITEM_SET, this.NPC, this.OBJECT, this.OUTFIT, this.PLAYER_CLASS, this.QUEST, this.RACE, this.RESOURCE, this.SKILL, this.SOUND, this.SPELL, this.ZONE],
        [WH.dataTree.D2]: [],
        [WH.dataTree.D4]: [this.D4_AFFIX, this.D4_ASPECT, this.D4_BUILD, this.D4_ITEM, this.D4_PARAGON_GLYPH, this.D4_PARAGON_NODE, this.D4_PLAYER_CLASS, this.D4_SENESCHAL_STONE, this.D4_SKILL, this.D4_VAMPIRIC_POWER],
        [WH.dataTree.DI]: [this.DI_EQUIP_ITEM, this.DI_MISC_ITEM, this.DI_NPC, this.DI_OBJECT, this.DI_PARAGON_SKILL, this.DI_QUEST, this.DI_SET, this.DI_SKILL, this.DI_ZONE]
    };
    const s = 0;
    const r = 1;
    const o = 2;
...
WH.effectAverage = function (e, t, a, i) {
    ...
    if (r != 0 && s != 0) {
        ...
        if (e["maxLevelScaling"] !== 0) {
            c = Math.min(c, e["maxLevelScaling"])
        }
        if (e["scalesWithItemLevel"]) {
            ...
            l = WH.convertScalingSpell.SV[t]?.[e - 1] ?? 1
        }
        if (s === WH.EFFECT_SCALING_CLASS_7 && e["aura"] && (e["aura"][i] === WH.EFFECT_AURA_DUMMY || e["aura"][i] === WH.EFFECT_AURA_PROC_TRIGGER_SPELL || e["aura"][i] === WH.EFFECT_AURA_PERIODIC_DUMMY)) {
            o = WH.getCombatRatingMult(c, 12)
        }
        return r * l * o
    }
...
WH.applyStatModifications = function (e, t, a, i, n, s, r, o) {
                ...
                for (var h = 0; h < p.length; ++h) {
                    ...
                    switch (g[0]) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            var _ = c.nsockets ? c.nsockets : 0;
                            c.nsockets = _ + g[1];
                            for (var y = _; y < _ + g[1]; ++y) {
                                c["socket" + (y + 1)] = g[2]
                            }
                            break;
                        case 8:
    ...
    if (e.statsInfo && e.level && WH.applyStatModifications.ScalingData && (WH.applyStatModifications.ScalingData.AL.length > 1 || w)) {
        ...
        if (c["dps"] || w) {
            ...
            if (w) {
                ...
                if (g[s] && g[s][t]) {
                    ...
                    x = Math.floor(e * c.speed * (1 + c.dmgrange / 2) + .5);
                    c["dmgmin1"] = k;
                    c["dmgmax1"] = x
                }
            } else {
    ...
    if (!W && l.nsockets || W && l.nsockets > W) {
        ...
        e = e.replace(/<!--ps-->(<br(?: \/)?>)?/, (function (e, f) {
            ...
            for (var S = W; S < l.nsockets; ++S) {
                ...
                var _ = WH.sprintf('<a href="' + WH.Strings.escapeHtml(W) + '" class="$1 q0">', I);
                _ += o.getSocketName(e) || "Unknown Socket";
                _ += "</a>";
                u += "<br>" + _
            }
...
WH.setTooltipSpells = function (e, t, a, i, n = 0) {
    ...
    for (var b = 0; b < p.length; ++b) {
        var _ = p[b].match(I)[2];
        var y = WH.inArray(t, parseInt(_)) >= 0 ? 1 : 0;
        if (a[_] == null) {
            continue
        }
        if (i[_] == null) {
        ...
        var L = "\x3c!--sp" + _ + ":" + y + "--\x3e" + A + "\x3c!--sp" + _ + "--\x3e";
    ...
    let R = new RegExp("\x3c!--useEffect:0:([0-9]+)--\x3e(.*?)\x3c!--useEffect:[0-9]+--\x3e", "gs");
    let M;
    while (M = R.exec(e)) {
        let t = WH.ce("div", {innerHTML: M[2]});
        let a = new RegExp("\x3c!--useText:0:" + M[1] + '--\x3e<span id="useText' + M[1] + '" class="q2".*?>(.*?</span>\x3c!--useText:' + M[1] + "--\x3e)", "s");
        e = e.replace(a, "\x3c!--useText:0:" + M[1] + '--\x3e<span id="useText' + M[1] + '" class="q2"' + (t.innerText === "" ? ' style="display:none"' : "") + ">$1")
    }
    return e
};
WH.enhanceTooltip = function (e, t, a, i, n, s, r, o, l, c, d, f, u) {
    ...
    if (t) {
        ...
        if (e.indexOf("\x3c!--artpow:") > 0) {
            if (!this.hasOwnProperty("_knowledgeLevel")) {
                var _ = /(&|\?)artk=(\d+)/.exec(location.href);
                if (_ && parseInt(_[2]) <= g_artifact_knowledge_max_level) {
                    this._knowledgeLevel = parseInt(_[2])
                }
            }
            var y = this._knowledgeLevel ? parseInt(this._knowledgeLevel) : 0;
            e = e.replace(/(<!--ndstart-->)?<!--ndend-->/i, (function (e, t) {
                return (t ? t + "<br />" : " ") + '<a href="javascript:" onmousedown="return false" class="tip" style="color: white; cursor: pointer" onclick="WH.staticTooltipKnowledgeLevelClick(this, null, ' + g + ')" onmouseover="WH.Tooltips.showAtCursor(event, \'<span class=\\\'q2\\\'>\' + WH.TERMS.clicktochangelevel_stc + \'</span>\')" onmousemove="WH.Tooltips.cursorUpdate(event)" onmouseout="WH.Tooltips.hide()">' + WH.sprintf(WH.TERMS.knowledge_format.replace("%d", "$1"), y) + "</a>"
            }));
            e = e.replace(/(<!--artpow:(\d+)-->)[\d\.\,]+/, (function (e, t, a) {
                return t + WH.numberLocaleFormat(WH.roundArtifactPower(parseInt(a) * WH.getArtifactKnowledgeMultiplier(y)))
            }))
        }
    }
    if (i && Slider) {
        ...
        if (n) {
            ...
            if (w && WH.isSet("g_difficulties") && g_difficulties[w]) {
                ...
                WH.difficultyBtnOnChange.call(this, m[g].initial_dd || w, m[g].initial_ddSize);
            ...
            if (this._rppmModList.hasOwnProperty(4)) {
                ...
                if (M.is(":empty")) {
                    ...
                    for (var N in this._rppmSpecModList) {
                        var D = Icon.create(this._rppmSpecModList[N]["filename"], 0, null);
                        D.style.display = "inline-block";
                        D.style.verticalAlign = "middle";
                        var O = $('<input name="rppmmod" type="radio" id="rppm-' + N + '" />');
                        O.get(0).checked = this._rppmSpecModList[N]["spec"] == -1;
                        M.append(O).append(this._rppmSpecModList[N]["spec"] == -1 ? "" : D).append('<label for="rppm-' + N + '"> <a>' + (this._rppmSpecModList[N]["spec"] == -1 ? WH.TERMS.none : WH.Wow.PlayerClass.Specialization.getName(this._rppmSpecModList[N]["spec"])) + "</a></label>").append("<br />");
                        var P = this;
                    ...
                    e = e.replace(/<!--rppm-->(\[?)(\d+(?:\.\d+)?)([^<]*)<!--rppm-->/, (function (e, t, a, i) {
                        return "\x3c!--rppm--\x3e" + t + (k * (1 + parseFloat(x[$('input[name="rppmmod"]:checked', M).attr("id").match(/\d+$/)[0]].modifiervalue))).toFixed(2) + i + "\x3c!--rppm--\x3e"
                    }))
                }
            }
            M.toggle(!M.is(":empty"));
    ...
    if (W == 3) {
        ...
        if (U && WH.Wow.Item.tooltipHasSpecStats(e)) {
            ...
            if (z) {
                Y = parseInt(z[2]);
                j = WH.Wow.PlayerClass.getBySpec(Y);
                if (j) {
                    F = {classId: j, specId: Y}
                }
            }
            if (F) {
...
WH.classSpecBtnOnChange = function (e, t, a, i) {
    ...
    o = o.replace(/<!--scstart(\d+):(\d+)--><span class="q(\d+)">(<!--asc\d+-->)?(.*?)<\/span><!--scend-->/i, (function (t, a, i, n, s, r) {
        n = 1;
        var o = a == 2 && (!g_classes_allowed_weapon[e] || WH.inArray(g_classes_allowed_weapon[e], i) == -1);
    ...
    if (WH.isRetailTree()) {
        o = o.replace(/<span[^>]*?><!--stat(\d+)-->([-+][\d\.,]+(?:-[\d\.,]+)?)(\D*?)<\/span>/gi, (function (a, i, n, s) {
        ...
        o = o.replace(/(<!--traitspecstart:(\d+)(?::(\d+))?-->)[\w\W]*?(<!--traitspecend-->)/g, (function (e, a, i, n, s) {
            var r = "";
...
WH.Game = new function () {
    ...
    const a = {
        ...
        [this.WOW]: {
            dataTrees: [WH.dataTree.RETAIL, WH.dataTree.CLASSIC, WH.dataTree.TBC, WH.dataTree.WRATH, WH.dataTree.CATA],
...
var Icon = {
    ...
    createUser: function (e, t, a, i, n, s, r) {
        ...
        } else if (r && Icon.privilegeBorderClasses.hasOwnProperty(r)) o.className += " " + o.className + Icon.privilegeBorderClasses[r];
    ...
    moveTexture: function (e, t, a, i, n) {
        ...
        s.backgroundSize = "";
        if (a || i) {
            if (n) s.backgroundPosition = a + "px " + i + "px"; else s.backgroundPosition = -a * Icon.sizes2[t] + "px " + -i * Icon.sizes2[t] + "px"
...
WH.Tooltips = WH.Tooltips || new function () {
    ...
    const l = 15;
    const c = 15;
    const d = [i.ACHIEVEMENT, i.AFFIX, i.AZERITE_ESSENCE, i.AZERITE_ESSENCE_POWER, i.ITEM, i.SPELL, i.DI_EQUIP_ITEM, i.DI_MISC_ITEM, i.DI_PARAGON_SKILL, i.DI_SKILL, i.D4_AFFIX, i.D4_ASPECT, i.D4_ITEM, i.D4_PARAGON_GLYPH, i.D4_PARAGON_NODE, i.D4_SKILL, i.D4_VAMPIRIC_POWER, i.D4_SENESCHAL_STONE];
    const f = {
    ...
    const u = (() => {
        let e = {
            ...
            [WH.dataTree.D4]: ["affix", "aspect", "guide", "item", "paragon-glyph", "paragon-node", "seneschal-stone", "skill", "vampiric-power"],
    ...
    const m = {0: "enus", 1: "kokr", 2: "frfr", 3: "dede", 4: "zhcn", 6: "eses", 7: "ruru", 8: "ptbr", 9: "itit"};
    const W = 320;
    const H = 0;
    const E = 5;
    const T = 3;
    ...
    const L = new RegExp(A + "\\??(" + u[WH.dataTree.RETAIL].join("|") + ")[=/](?:[^/?&#]+-)?(-?\\d+(?:\\.\\d+)?)" + w);
    const C = new RegExp(A + "(guide)s?/([^?&#]+)");
    const R = (() => [WH.dataEnv.MAIN, WH.dataEnv.PTR, WH.dataEnv.PTR2, WH.dataEnv.BETA, WH.dataEnv.CATA, WH.dataEnv.D4, WH.dataEnv.D4PTR, WH.dataEnv.D4BETA, WH.dataEnv.WRATH, WH.dataEnv.DI, WH.dataEnv.TBC, WH.dataEnv.CLASSIC, WH.dataEnv.D2].map((e => {
        ...
        return {
            ...
            regexFrontPaths: new RegExp(r + o + "/(?:[^/?&#]+-)?(\\d+)" + w),
    ...
    const B = 4;
    const F = 5;
    const U = {[P]: "loading", [F]: "loading", [k]: "error", [O]: "loading", [x]: "error", [B]: "ok"};
    const G = [i.GUIDE];
    const q = {
        0: {
    ...
    this.getEntity = function (e, t, a, i) {
        ...
        n[t] = n[t] || {};
        n[t][a] = n[t][a] || {};
        n[t][a][i] = n[t][a][i] || {status: O, callbacks: [], data: {}};
        return n[t][a][i]
    };
    this.init = function () {
        Q();
    ...
    this.parseItemEffectTooltipForSpec = (e, t) => e.replace(/<!--itemeffectspec(\d+):0--><span(?: hidden.*?)?>(.*?)<\/span><!--itemeffectspec-->(<br>|<br \/>|<\/span>)?/g, (function (e, a, i, n) {
        a = parseInt(a);
    ...
    this.register = function (t, a, n, s, r) {
        ...
        }
        {
            ...
            if (typeof a === "string" && (a.indexOf("lvl") === 0 || a.match(/[^i]lvl/)) && !ot.isLoaded(i.SPELL, n)) {
                o.status = F;
    ...
    if (!WH.REMOTE) {
        ...
        this.relToParams = e => {
            let t = {};
            e.forEach((e => e.replace(_, ((e, a, i) => Be(t, a, i) || ""))));
            return t
        };
    ...
    function Ye(a, n, r) {
        if (n && a.dataset && a.dataset.simpleTooltip) {
            ...
            Xe(a, a.dataset.simpleTooltip.length < 30 ? '<div class="no-wrap">' + a.dataset.simpleTooltip + "</div>" : a.dataset.simpleTooltip);
            return D
        }
            ...
            if (e) {
                ...
                R.some((e => {
                    ...
                    if (t) {
                        ...
                        w = (e.prefixedDetailPageNames.includes(t[2]) ? e.detailPagePrefix : "") + t[2];
                        A = t[3];
                        k = l
                    }
                    return !!t
        ...
        l.replace(_, ((e, t, a) => Be(W, t, a) || ""));
        if (o) {
            o.replace(_, ((e, t, a) => Be(W, t, a) || ""))
        }
        z.element = a;
        let U = Fe(b, W.domain);
        let G = U.dataEnv;
        let q = U.locale;
        let j = WH.Types.getRequiredTrees(x) || [];
        if (j.length && !j.includes(WH.getDataTree(G))) {
            G = WH.getRootByTree(j[0])
        }
        let K = t.getByEnv(G);
        if (K === t.WOW) {
            if (W.gems && W.gems.length > 0) {
                var V;
                for (V = Math.min(3, W.gems.length - 1); V >= 0; --V) {
                    if (parseInt(W.gems[V])) {
                        break
                    }
                }
                ++V;
                if (V === 0) {
                    delete W.gems
                } else if (V < W.gems.length) {
                    W.gems = W.gems.slice(0, V)
                }
            }
            var Q = ["bonus", "gem1bonus", "gem2bonus", "gem3bonus"];
            for (var J = 0, X; X = Q[J]; J++) {
                if (W[X] && W[X].length > 0) {
                    for (V = Math.min(16, W[X].length - 1); V >= 0; --V) {
                        if (parseInt(W[X][V])) {
                            break
                        }
                    }
            ...
            if (W.abil && W.abil.length > 0) {
                var V, Z = [], ee;
                for (V = 0; V < Math.min(8, W.abil.length); V++) {
                    if (ee = parseInt(W.abil[V])) {
                        Z.push(ee)
                    }
                }
                if (Z.length === 0) {
            ...
            if (W.rewards && W.rewards.length > 0) {
                var V;
                for (V = Math.min(3, W.rewards.length - 1); V >= 0; --V) {
                    if (/^\d+.\d+$/.test(W.rewards[V])) {
                        break
                    }
                }
                ++V;
                if (V === 0) {
                    delete W.rewards
                } else if (V < W.rewards.length) {
                    W.rewards = W.rewards.slice(0, V)
                }
            }
        }
        if (l.indexOf("#") !== -1 && document.location.href.indexOf(w + "=" + A) !== -1) {
            return N
        }
        z.show.mode = H;
        ...
        if (!WH.REMOTE && !a.whContextMenuAttached) {
            ...
            WH.aE(a, "contextmenu", Ne.bind(a, G, q, x, w, A, W, k))
        }
        if (n) {
        ...
        let se = e.getEntity(x, ue(x, A, W), G, q);
        var re = [];
        ...
        if ((le === "true" || oe || We("iconizeLinks")) && le !== "false" && d.includes(x)) {
            if (!oe) {
                oe = We("iconSize")
            }
            re.push((function () {
        ...
        if (re.length) {
            if (se.status === O || se.status === P) {
                se.callbacks = se.callbacks.concat(re);
                if (se.status === O) {
                    ze(x, A, G, q, true, W)
                }
    ...
    function Xe(e, t, a, i) {
        ...
        Ve(i);
        je(t, i.finalContent2, i.image, i.imageClass);
    ...
    function et(e, t, a, i) {
        ...
        Ve(i);
        je(e, i.finalContent2, i.image, i.imageClass);
    ...
    function tt(e, t, a) {
        ...
        Ve(a);
        je(t, a.finalContent2, a.image, a.imageClass);
        Re()
    }
    ...
    function it(t, n, s, r, d, f, u, p, h, g) {
        ...
        if (!s) {
            ...
            if (e.pcs && e.pcs.length) {
                var W = 0;
                for (var b = 0, _ = e.pcs.length; b < _; ++b) {
                    var y;
                    var w = new RegExp("<span>\x3c!--si([0-9]+:)*" + e.pcs[b] + "(:[0-9]+)*--\x3e" + '<a href="[^"]*?/item=(\\d+)[^"]*">(.+?)</a></span>');
                    if (y = s.match(w)) {
                        let t = !isNaN(parseInt(z.show.locale)) ? m[z.show.locale] : "enus";
                        var A = WH.isSet("g_items") && g_items[e.pcs[b]] ? g_items[e.pcs[b]]["name_" + t] : y[4];
                        let a = WH.REMOTE ? "javascript:" : WH.Entity.getUrl(WH.Types.ITEM, y[3]);
                        var L = '<a href="' + a + '">' + A + "</a>";
            ...
            if (z.show.type === i.ACHIEVEMENT && e.cri) {
                for (var b = 0; b < e.cri.length; b++) {
                    s = s.replace(new RegExp("\x3c!--cr" + parseInt(e.cri[b]) + ":[^<]+", "g"), '<span class="q2">$&</span>')
                }
            }
        }
        if (z.showCharacterCompletion && window.g_user && (WH.isRetailTree(z.show.dataEnv) && g_user.lists || !WH.isRetailTree(z.show.dataEnv) && g_user.characterProfiles && g_user.characterProfiles.length)) {
            ...
            if (a) {
                for (var M in g_user.lists) {
                    ...
                    R += '<br><span class="progress-icon ' + (e ? "progress-8" : "progress-0") + '"></span> ';
            ...
            if (WH.isRetailTree(z.show.dataEnv) && z.show.type === i.TRANSMOG_SET) {
                (g_user.lists || []).forEach((function (e) {
                    ...
                    if (t > 0) {
                        R += '<br><span class="progress-icon progress-' + Math.max(1, Math.floor(t * 8)) + '"></span> ';
    ...
    function nt() {
        ...
        it(t.status, z.show.locale, t.data[ve()], t.data, t.data[pe()], t.data.map, t.data[Te()], t.data[ve(2)], a, i)
    }
